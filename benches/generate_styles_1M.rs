...
//!
//! Run with: cargo run --example generate_styles_1M
//!
//! This creates `tests/styles_1M.xlsx` with 1000 copies of style patterns.
...
fn main() -> Result<(), XlsxError> {
    ...
    let _fill_cyan = Format::new().set_background_color(Color::Cyan);
    let _fill_magenta = Format::new().set_background_color(Color::Magenta);
    let _fill_orange = Format::new().set_background_color(Color::Orange);
