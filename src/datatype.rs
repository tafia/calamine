...
impl ExcelDateTime {
    ...
    // Convert Excel serial datetime to stand date components.
    ...
    // account for the infamous Excel date bug where it treats 1900 as a leap
    // year.
    //
    // Works in the range 1899-12-31/1904-01-01 to 9999-12-31.
    //
    // Leap seconds and the time zone aren't taken into account since Excel
    // doesn't handle them.
    //
    pub(crate) fn excel_to_standard_datetime(
        excel_datetime: f64,
        is_1904: bool,
...
mod tests {
    ...
    fn test_datetimes_1900_epoch() {
        let test_data = vec![
            ...
            (362261.10042934027, (2891, 10, 31, 2, 24, 37, 095)),
            ...
            (815087.24078782403, (4131, 8, 18, 5, 46, 44, 068)),
            ...
            (1056594.3536005903, (4792, 11, 7, 8, 29, 11, 091)),
            ...
            (2022624.7456143056, (7437, 10, 2, 17, 53, 41, 076)),
            (2052812.7465977315, (7520, 5, 28, 17, 55, 6, 044)),
            ...
            (2415073.8682530904, (8512, 3, 29, 20, 50, 17, 067)),
    ...
    fn test_times_only_both_epochs() {
        let test_data = vec![
            ...
            (0.10042934027777778, (2, 24, 37, 095)),
            ...
            (0.24078782407407406, (5, 46, 44, 068)),
            ...
            (0.35360059027777774, (8, 29, 11, 091)),
            ...
            (0.74561430555555563, (17, 53, 41, 076)),
            (0.74659773148148145, (17, 55, 6, 044)),
            ...
            (0.86825309027777775, (20, 50, 17, 067)),
